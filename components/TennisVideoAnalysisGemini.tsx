...
interface AnalysisType {
  id: 'technique' | 'performance' | 'tactical' | 'custom';
  name: string;
  description: string;
  icon: string;
}
...
const ANALYSIS_TYPES: AnalysisType[] = [
  {
    ...
    description: 'Focus on stroke mechanics, form, and technical improvements',
    icon: '🎾'
  },
  {
    id: 'performance',
    name: 'Performance Analysis',
    description: 'Analyze shot selection, consistency, and overall performance',
    icon: '📊'
  },
  {
    id: 'tactical',
    name: 'Tactical Analysis',
    description: 'Strategic patterns, point construction, and game tactics',
    icon: '🧠'
  },
  {
    id: 'custom',
...
export default function TennisVideoAnalysisGemini() {
  const { t } = useLanguage();
  ...
  const [analysisType, setAnalysisType] = useState<'technique' | 'performance' | 'tactical' | 'custom'>('technique');
  ...
  const setDefaultPrompt = (type: typeof analysisType) => {
    const defaultPrompts = {
      technique: 'Analyze the player\'s technique in this tennis video. Focus on stroke mechanics, body positioning, and provide specific recommendations for improvement.',
      performance: 'Evaluate the player\'s performance in this tennis video. Analyze shot selection, consistency, movement patterns, and overall gameplay effectiveness.',
      tactical: 'Examine the tactical aspects of this tennis match. Analyze strategic patterns, point construction, court positioning, and provide tactical insights.',
      custom: 'Provide a comprehensive analysis of this tennis video, covering technique, performance, and tactical aspects as relevant.'
    };
  ...
  const startAnalysis = async () => {
    ...
    try {
      ...
      const useFileAPI = await shouldUseFileAPI(selectedFile);
      
      if (useFileAPI) {
        console.log('Using File API for large video...');
        setUploadProgress(25);
        const result = await analyzeVideoWithFileAPI(request);
        setUploadProgress(100);
        setAnalysisResult(result);
      } else {
        console.log('Using inline data for smaller video...');
    ...
    <div className="max-w-6xl mx-auto p-6">
      <div className="mb-8">
        ...
        <p className="text-lg text-gray-600">
          Upload your tennis video and get professional AI-powered analysis using Gemini 2.5 Pro
        </p>
      </div>

      {/* Video Upload Section */}
      <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
        <h2 className="text-xl font-semibold mb-4">1. Upload Tennis Video</h2>
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6">
          ...
          <div className="mb-4">
            <label className="block text-sm font-medium text-gray-700 mb-2">
              What would you like to analyze in this tennis video?
            </label>
            <textarea
              value={userPrompt}
            ...
            />
            <p className="text-sm text-gray-500 mt-2">
              Be specific about what you want to analyze. You can ask about technique, strategy, specific shots, timestamps, or any other aspect of the game.
            </p>
          </div>
      ...
      {!selectedFile && (
        <div className="bg-blue-50 rounded-lg p-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-blue-800">
            <li>Upload a tennis video (MP4, MOV, AVI, or WebM format, max 5 minutes)</li>
            <li>Choose your analysis type: Technique, Performance, Tactical, or Custom</li>
          ...
          <div className="mt-4 p-4 bg-blue-100 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-1 text-blue-800 text-sm">
              <li>Use clear, well-lit videos with good visibility of the player and court</li>
              <li>Include specific timestamps in your prompt if you want to focus on particular moments</li>
              <li>Be specific about what you want to analyze (e.g., "analyze my serve technique at 1:30")</li>
              <li>For technique analysis, videos showing the full body and stroke motion work best</li>
            </ul>
          </div>
        </div>
      )}
